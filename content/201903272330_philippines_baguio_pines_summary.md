...
1. 生徒が多い
    ...
    生徒数はかなりの数で、感覚として300人は超えていると思います。

    周期として、半月〜1ヶ月ごとに新しい生徒たちが入ってきます。

    自分がPINESに入ったときは、50人くらいが同時期に入って、入学〜オリエンテーションを行いました。

2. 学校が大きい

    学校は4階建てでしたが、5階を増築していました。
...
実体験として、パインスはスパルタ校と呼ぶに相応しいだけの授業量と厳格なルールはありました。
...
自分のTwitterの内容をDailyでまとめてあるので、興味がある人はこちらもどうぞ
