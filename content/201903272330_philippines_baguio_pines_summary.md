...
1. メインキャンパス(新校舎)
    ...
    - ここの「学生寮」「教室」については、下記の記事で紹介しています。
...
1. 生徒が多い
    ...
    - 自分がPINESに入ったときは、30人くらいが同時期に入って、入学〜オリエンテーションを行いました。
...
実体験として、学校のご飯ですが意外にもフィリピン料理の比率が多かったように感じました。
...
ただ、朝昼夜の学校の食事にほぼ毎回キムチが準備されているあたりは韓国資本らしかったです。
...
- 食堂でご飯が配給されるが、生徒数が多すぎて行列に並んで配給を受け取るだけでも15分くらいかかる。
