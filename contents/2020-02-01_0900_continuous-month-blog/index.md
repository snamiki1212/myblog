...
（ここのトピックではわかりやすく、①② の２つに簡略化して説明します。後述しますが、本当はもうちょいあります。）

今では「① 設計」にかなり時間をかけるようになりました。
...
今までは、「② 実装」のまま進んでいたのですが、

- 文章が長くなりすぎる
- トピックが行ったり来たり

みたいな感じで「空中分解」するケースがあったのですが、最近はだいぶ減りました。
...
というのも、リライト＝リファクタが必要なボリュームになってきているので。
...
今までは、記事数が少ないので、アジャイルする必要もあまりなかったんですが、増えました。
...
の記事って、書くネタが脳内のあります。つまり、書くのが簡単なんですよね。
