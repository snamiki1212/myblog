---
title: '【退職エントリ】NTT系SIを退職しWebベンチャーへ転職'
cover: 'cover.jpg'
createdAt: '2017-06-01 00:00'
updatedAt: '2020-12-26 00:00'
category: 'キャリア'
tags:
  - キャリア
...
というわけで、この会社を退職した。次の会社へ転職する。

### 転職理由とか

転職先の選定とかは大きくは下記の３つ点がポイントで見ていた。

* 技術：プレイヤーとしてスキルをつけれるようになりたい
* 文化：金融系がつまらないので、楽しく自由な風潮にシフトしたい
* 業界：出向して社内SEも経験したけど、SIer業界に絶望した

今回のケースは、転職＋キャリアチェンジなのでかなり大きい移動になる。

### 転職先

というわけで、Web系のベンチャーの１つに転職することにした。

受託開発でキャッシュをためつつ自社サービスも開発して一発当てようとしてる会社。メンバーの数も20人くらいでかなり少ない状態。

なので、手を上げたら何でもできるので、とにかく仕事を通じて技術力・経験値を稼ぎまくる予定。
...
リスクを取らずに時間をかけるなら、それでもよかったかもしれない。

けど、社内的には下請けに発注することが多いので、そこまで開発リソースが潤沢ではないように見えた。そもそも、金融系に向けたシステム開発なので、レガシーなDXだっただろうし、みんながアジャイル・スクラムを知らない・都市伝説だと思ってるような世界線なので、ウォーターフォールで命を削ってる感じもあったから、個人的には転職しちゃってよかったかと思う。
