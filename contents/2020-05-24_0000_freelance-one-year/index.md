...
以前は、エージェントも使ってたんですが中抜きがデカイのでやめました。なので、今の自分の仕事探しは基本的に Twitter ＋ Wantedly を今はメインにしてます。
...
仕事探しで一番面倒だと感じるのは経歴書とかの資料を準備する点だと思うのですが、一度きちんと整備すれば、「最終更新日〜今日」の diff を更新すればいいだけです。その後は周期を短くメンテナンスすれば、5 分くらいで最新情報にアップデートできるようになります。1 年位ほっておいても、そこまで diff も増えませんね。
...
「フリーランスを 1 回やってみたい」と気になってるなら、とりあえず 1 回やってみるのは個人的にはアリだと思ってます。
...
・Freee を使え
・その場その場でググればどうにかなる。
・とはいえ、会計の知識は正社員の時点で知っておくべきだった。具体的には簿記の資格取っておけばよかった。そのばその場でググってるので、知識が一本線を通ってないし、内容を完全に理解してないで、Freee をポチポチして確定申告・納税も終わらせたので。
