...
仕事探しで一番面倒だと感じるのは経歴書とかの資料を準備する点だと思うのですが、一度きちんと整備すれば、「最終更新日〜今日」の diff を更新すればいいだけ。その後は周期を短くメンテナンスすれば、5 分くらいで最新情報にアップデートできるようになります。1 年位ほっておいても、そこまで diff も増えませんね。

あとは自分のアピールしたいアウトプットなどをまとめておけば、この URL を渡せば OK です。URL を渡してるのに、同じような質問をチャットでしてくる人もたまにいましたが、「この URL 見てください」だけの塩を対応してました。
...
生存バイアスなところもあるかと思いますが、基本的にその場その場でググればどうにかなる印象です。
...
必ず契約時、契約前の金額交渉のときに明示して伝えるべきでした。というのも、これによって、**収入が 10%変わります**。
